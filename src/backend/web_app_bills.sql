...
CREATE TABLE `bills` (
  ...
  `bill_type` enum('Mobile','Creditcard','Utilities') DEFAULT NULL,
  `bill_name` varchar(45) DEFAULT NULL,
  `providers` varchar(45) DEFAULT NULL,
  `frequency_type` enum('Once','Weekly','Monthly') DEFAULT NULL,
  `phone_number` varchar(15) DEFAULT NULL,
  `card_number` varchar(20) DEFAULT NULL,
  `utils_number` varchar(50) DEFAULT NULL,
